...
export const gatewayCopy = {
  zh: {
    ...
    previewQuote: "构成我们的不是原子，而是故事。",
    previewAuthor: "——米里尔・鲁凯泽",
  ...
  en: {
    ...
    previewQuote: "We are made of stories, not atoms.",
    previewAuthor: "— Muriel Rukeyser",
    ...
    login: "Log in",
    nickname: "Nickname",
    nicknameHint: "Others will see this instead of username",
